...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/interview/flexsearch.min.js');loadScript('/interview/en.search-data.min.9e90c599c3e27aae1a695d7b5057181d09dacbb0a6627b50be3b31174be9b97a.js',function(){input.required=false;search();});}
